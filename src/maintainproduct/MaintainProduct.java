...
public class MaintainProduct {
    ...
    public static void main(String[] args) {
        ...
        product product2 = new product(2,"Flesh Flower","Sunflower", 50.50, 4, "Yes", "Out Of Stock");
        product product3 = new product(3,"Dry Flower","Sunflower", 20.50, 0, "No", "In Stock");
...
//        do{
            ...
            for(int i = 0; i < productList.size(); i++){
                if(productList.get(i).getQuantity() < 1){
                    System.out.println(productList.get(i).getName() + "\t\t\tOut of Stock");
                }
                else if(productList.get(i).getQuantity() < 5 && productList.get(i).getQuantity() > 0){
                    System.out.println(productList.get(i).getName() + "\t\t\tStock Running Low");
                }
                else if(productList.get(i).getQuantity() > 5){
                    System.out.println(productList.get(i).getName() + "\t\t\t\tIn Stock");
                }
...
//                }
    ...
    for(int i = 0; i < productList.size(); i++){
                if(productList.get(i).getQuantity() < 1){
                    productList.get(i).setAlert("Out Of Stock");
                    
                }
                else if(productList.get(i).getQuantity() < 5 && productList.get(i).getQuantity() > 0){
                    productList.get(i).setAlert("Stock Running Low");
                    
                }
                else if(productList.get(i).getQuantity() > 5){
                    productList.get(i).setAlert("In Stock");
    ...
    public static void showProductList(){
        ...
        System.out.println("No. Item\t" + "  ProductType\t\t" + "  Name\t\t" + "  Price\t\t" + "Quantity\t\t" + "Promotion\t\t" + "Stock");
        System.out.println("=============================================================================================1=======================================");
            for(int i =0; i<productList.size(); i++){
                System.out.printf("%-3d \t\t %-10s \t\t %-10s \t RM%.2f %8d \t\t\t %-10s\t\t %-10s\n\n", i+1, productList.get(i).getProductType(), productList.get(i).getName(), productList.get(i).getPrice(), productList.get(i).getQuantity(), productList.get(i).getPromo(), productList.get(i).getAlert());
            }
